...
You can access the https://library.netapp.com/ecm/ecm_download_file/ECMLP2879854[ONTAP Select 9.10.1 Release Notes^] to view the details about the current version.
